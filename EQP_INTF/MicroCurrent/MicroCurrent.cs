...
namespace EQP_INTF.MicroCurrent
{
    public partial class MicroCurrent : UserControl
    {
        ...
        private void AddFMSBrowsePath(OPCUAClient.OPCUAClient Client)
        {
            ...
            //JigProcess
            browsePathList.Add("Jig1.JigProcess.RequestRecipe");
            browsePathList.Add("Jig1.JigProcess.ProcessStart");
            browsePathList.Add("Jig1.JigProcess.ProcessEnd");
            browsePathList.Add("Jig1.JigProcess.NextDestination.EquipmentId");
            browsePathList.Add("Jig1.JigProcess.NextDestination.ProcessId");
            browsePathList.Add("Jig1.JigProcess.NextDestination.UnitId");

            //JigInformation
            browsePathList.Add("Jig1.JigInformation.CellCount");
            browsePathList.Add("Jig1.JigInformation.JigName");
            browsePathList.Add("Jig1.JigInformation.LotId");
            browsePathList.Add("Jig1.JigInformation.ProcessId");
            browsePathList.Add("Jig1.JigInformation.ProductModel");
            browsePathList.Add("Jig1.JigInformation.RouteId");
            browsePathList.Add("Jig1.JigInformation.TrackInTrayId");
        ...
        private void AddRecipeBrowsePath(OPCUAClient.OPCUAClient Client, MappingDirection mappingDirection)
        {
            ...
            if (mappingDirection == MappingDirection.EqpToFms)
            {
                ...
                recipeDataList.Add("Recipe.NextStepExist");
                recipeDataList.Add("Recipe.StepNo");

                TagName = "Recipe";
            }
            else
            {
                recipeDataList.Add("Jig1.Recipe.NextProcessExist");
                recipeDataList.Add("Jig1.Recipe.RecipeId");
                recipeDataList.Add("Jig1.Recipe.OperationMode");
            ...
            {
                browseName = string.Format($"{TagName}.{item.Key}");
        ...
        private void AddProcessDataBrowsePath(OPCUAClient.OPCUAClient Client, MappingDirection mappingDirection)
        {
            ...
            if (mappingDirection == MappingDirection.EqpToFms)
            {
                processDataList.Add("CellInformation.StartAirTemp");
                processDataList.Add("CellInformation.EndAirTemp");
                processDataList.Add("CellInformation.AvgAirTemp");
        ...
        public void _LOG_(string strDescription, ECSLogger.LOG_LEVEL level = ECSLogger.LOG_LEVEL.ALL)
        {
            ...
            string log = $"{EQPID}, JIG, {caller}, {strDescription}";
