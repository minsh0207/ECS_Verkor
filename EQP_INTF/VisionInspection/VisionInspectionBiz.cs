...
namespace EQP_INTF.VisionInspection
{
    public partial class VisionInspection : UserControl
    {
        ...
        private void InitDisplayWithCurrentValue(OPCUAClient.OPCUAClient OPCClient)
        {
            ...
            ReadPath.Add("ManualLocation.CellManualOut.ResultData");
            ...
            try
            {
                ...
                if (eventItem != null)
                {
                    ...
                    if (bProcessStartResponse)
                    {
                        ...
                        //20230406 sgh TrayID 문자열로 넘기도록 수정
            ...
            try
            {
                ...
                if (eventItem != null)
                {
                    ...
                    if (bCellUnloadComplete)
                    {
                        ...
                        _LOG_("[EQPClient] Response for CellUnloadComplete to EQP Sucess [PickPlaceLocationLocation.CellTrackOut.CellUnloadCompleteResponse:true]");
                    }
                    else
                    {
                        // reset
                        ...
                        {
                            _LOG_("[EQPClient] Fail to write RequestRecipeResponse on EQP [PickLocation.CellTrackOut.CellUnloadCompleteResponse:false]", ECSLogger.LOG_LEVEL.ERROR);
                            return;
                        }
                        _LOG_("[EQPClient] Clear for CellUnloadCompleteResponse to EQP Sucess [PickLocation.CellTrackOut.CellUnloadCompleteResponse:false]");
                    }
        ...
        private void SetEQPMonitoredItemList()
        {
            ...
            EQPClient.m_monitoredItemList.Add("ManualLocation.CellManualOut.ResultData");
        }
